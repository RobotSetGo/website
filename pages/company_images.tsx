...
const images = [
  {
    path: require("../assets/img/company/1.jpg"),
    description: "Εξωτερική όψη της σχολής μας",
  },
  {
    path: require("../assets/img/company/3.jpg"),
    description: "Αίθουσα 1 (Γενική)",
  },
  {
    path: require("../assets/img/company/5.jpg"),
    description: "Αίθουσα 1 (Σχέδιο)",
  },
  {
    path: require("../assets/img/company/7.jpg"),
    description: "Αίθουσα 2 (Γενική)",
  },
  {
    path: require("../assets/img/company/6.jpg"),
    description: "Αίθουσα 2 (Σχέδιο)",
  },
  {
    path: require("../assets/img/company/8.jpg"),
    description: "Αίθουσα 3 - Αμφιθέατρο (Σχέδιο)",
  },
  {
    path: require("../assets/img/company/4.jpg"),
    description: "Αίθουσα 3 - Αμφιθέατρο (Σχέδιο)",
  },
  {
    path: require("../assets/img/company/2.jpg"),
          ...
          <div className="flex flex-wrap items-center my-12">
            <div className="w-full md:w-10/12 px-6 mr-auto ml-auto">
              <div className="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                ...
                <img
                  src={require("../assets/img/company/base.jpg")}
                  alt="school-base"
                />
