...
function RoboticsBody({ type }) {
  switch (type) {
    case "spike":
      return (
        <div>
          Το εκπαιδευτικό πακέτο <strong>LEGO® Education SPIKE ™</strong> είναι
          το εργαλείο εκμάθησης STEAM για μαθητές ηλικίας 8 έως 11. Συνδυάζοντας
          τα πολύχρωμα τουβλάκια της LEGO και περιέχοντας εύχρηστο υλικό και μια
          γλώσσα κωδικοποίησης βασισμένη στο Scratch, το SPIKE συνεχώς
          ενθαρρύνει τους μαθητές μέσω παιχνιδιάρικων μαθησιακών δραστηριοτήτων
          να σκέφτονται κριτικά και να επιλύουν σύνθετα προβλήματα, ανεξάρτητα
          από το επίπεδο μάθησης. Από τις πιο απλές κατασκευές έως τις
          απεριόριστες δυνατότητες δημιουργικού σχεδιασμού, το SPIKE βοηθά τους
          μαθητές να μάθουν τις βασικές δεξιότητες STEAM και 21ου αιώνα που
          απαιτούνται για να γίνουν τα πρωτοποριακά μυαλά του αύριο … ενώ
          ταυτόχρονα διασκεδάζουν!
        </div>
      );
    case "ev3":
      return (
    ...
    case "beebot":
      return (
        <div>
          ...
          συνιστούν τα προγραμματιζόμενα παιχνίδια τύπου Logo τα οποία βρίσκουν
          ιδιαίτερη εφαρμογή στην προσχολική και στην πρώτη σχολική ηλικία .Τα
          παιδιά σχεδιάζουν και καθορίζουν το σύνολο των εντολών που εισάγονται
          στα ρομπότ κατά περίσταση , ακολουθώντας τις αρχές της γλώσσας
          προγραμματισμού Logo που ευνοεί την ανάπτυξη μεταγνωστικής ικανότητας
          , και την οποία τα παιδιά αναστοχάζονται σχετικά με τις διαδικασίες
          σκέψης που έχουν ακολουθήσει , βελτιώνει την ικανότητα χωρικού
          προσανατολισμού . Ένα από τα πιο διαδεδομένα προγραμματιζόμενα
          παιχνίδια είναι το Bee-Boot, το οποίο ενσαρκώνει τη μέλισσα Logo και
          βασίζεται σε αρχές προγραμματισμού της γλώσσας αυτής για τον έλεγχο
          του ρομπότ δαπέδου .Τα παιδιά μπορούν έτσι να προγραμματίσουν μια
          διαδρομή πάνω σε ένα δάπεδο .Το ρομπότ έχει το σχήμα και τα χρώματα
          της μέλισσας .Ο προγραμματισμός των κινήσεων βρίσκεται στο πάνω μέλος
          του ρομπότ και στηρίζεται σε ένα σύνολο χρωματικών πλήκτρων. Τέσσερα
          πορτοκαλί πλήκτρα εξυπηρετούν την εμπρόσθια και οπίσθια κίνηση και την
          περιστροφή αριστερά/δεξιά. Το κεντρικό πλήκτρο (GO) χρησιμοποιείται
          για την εκτέλεση των εντολών του παιχνιδιού .Τα δύο μπλε πλήκτρα
          εξυπηρετούν διαφορετικές λειτουργίες .Το ένα ( CLEAR ) χρησιμεύει για
          την διαγραφή των εντολών από τη μνήμη .Το δεύτερο ( PAUSE ) παρέχει τη
